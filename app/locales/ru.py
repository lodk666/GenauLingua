...
🗂️ <b>Категории слов</b>
Учи слова по темам — еда, транспорт, работа, путешествия и другие.

📚 <b>Уровни B2–C2</b>
Сейчас доступны A1–B1. В работе база для B2, C1 и C2.

📖 <b>30 000 слов</b>
Расширение базы до 30 000 слов с переводами на все 4 языка.

🔄 <b>Новые режимы обучения</b>
Больше форматов для изучения слов — не только викторины.
