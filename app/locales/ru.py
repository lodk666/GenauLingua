...
TEXTS = {
    ...
    "report_sent": "✅ Отправлено {count} репортов — спасибо!\nЕсли ошибка подтвердится — получишь +1 балл",
    "report_daily_limit": "⚠️ Лимит репортов на сегодня исчерпан (макс. 20)",
    "report_all_reported": "✅ Все слова из этой викторины уже зарепорчены",
    "report_already_sent": "✔️ Уже отправлено ранее",
...
💬 Следи за обновлениями: t.me/genaulingua_chat""",
    ...
    "rating_scoring_report": "• Подтверждённый репорт → +1",
